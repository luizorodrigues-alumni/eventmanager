...
import com.luiz.eventmanager.dto.ErrorMessage;
...
import com.luiz.eventmanager.service.SubscriptionService;
...
public class SubscriptionController {
    ...
    public ResponseEntity<?> generateRankingByEvent(@PathVariable String prettyName, ServletResponse servletResponse){
        try{
